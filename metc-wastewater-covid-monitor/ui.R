      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: March 13, 2023. <br>*All data are preliminary and subject to revision</h3>"),
          ...
          tabPanel(
            ...
            h6("March 17, 2023"),
            p(
              "The most recent data update includes samples taken March 7 - March 13 2023. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant was remained steady last week, increasing by only 2% compared to a week earlier."),
              tags$li("BA.2 and BA.5 sublineages contributed 93% and 5%, respectively, of the viral RNA load entering Metro last week, unchanged from a week earlier."),
              tags$li(
            ...
            br(),
            p(tags$b("Summary: "), "The total level of virus remained relatively steady last week compared to the previous week. XBB sublineages are the dominant SARS-CoV-2 variants in the Metro Plant service area.")
          )
        )
      )
    ),
