      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: August 29, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("September 2, 2022"),
            p(
              "The most recent data update includes samples taken August 23 - August 29, 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant decreased by 19% last week compared to a week earlier."
              ),
              tags$li("The load of BA.5 RNA decreased by 15% last week compared to the previous week."
              ),
              tags$li("BA.5 constituted 90% of the viral RNA entering Metro, and BA.4 and BA.2 represented 10% and 1%, respectively, of the total viral RNA load."
              ),
