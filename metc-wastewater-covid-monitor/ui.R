      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: August 15, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("August 19, 2022"),
            p(
              "The most recent data update includes samples taken August 9 - August 15, 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant decreased by 2% last week compared to a week earlier; it has dropped by 18% since June 21, or about 2.5% per week."
              ),
              tags$li("The load of BA.5 RNA decreased by 3% last week compared to the previous week."
              ),
              tags$li("The load of BA.4 RNA increased by 24% last week, and has increased by 36% over the past two weeks."
              ),
              tags$li("BA.5 constituted 84% of the viral RNA entering Metro, and BA.4 and BA.2 represented 14% and 1%, respectively, of the total viral RNA load."
              ),
