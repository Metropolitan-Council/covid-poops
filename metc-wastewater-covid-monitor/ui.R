      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: September 5, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("September 9, 2022"),
            p(
              "The most recent data update includes samples taken August 30 - September 5, 2022. During this sampling period:"
            ),
            tags$ul(
