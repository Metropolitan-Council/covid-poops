      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: August 6, 2023. <br>*All data are preliminary and subject to revision</h3>"),
          ...
          tabPanel(
            ...
            h6("August 11, 2023"),
            p(
              "The most recent data update includes samples taken July 31 to August 6, 2023. During this sampling period:"
            ),
            tags$ul(
              tags$li("The weekly average viral RNA load entering the Metro Plant increased by 31% this week driven by an elevated value on one day."),
