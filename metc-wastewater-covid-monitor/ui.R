      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: August 22, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("August 26, 2022"),
            p(
              "The most recent data update includes samples taken August 16 - August 22, 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant increased by 4% last week compared to a week earlier."
              ),
              ...
              tags$li("The load of BA.5 RNA increased by 8% last week compared to the previous week."
              ),
              tags$li("The load of BA.4 RNA decreased by 28% last week, and is now back down to where it was three weeks ago."
              ),
              tags$li("BA.5 constituted 87% of the viral RNA entering Metro, and BA.4 and BA.2 represented 9% and 1%, respectively, of the total viral RNA load."
              ),
