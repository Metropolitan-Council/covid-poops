      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date:July 2, 2023. <br>*All data are preliminary and subject to revision</h3>"),
          ...
          tabPanel(
            ...
            h6("July 7, 2023"),
            p(
              "The most recent data update includes samples taken June 26 to July 2, 2023. During this sampling period:"
            ),
            tags$ul(
