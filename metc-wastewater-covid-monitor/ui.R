      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: October 3, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("October 7, 2022"),
            p(
              "The most recent data update includes samples taken September 27 - October 3 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant was essentially unchanged last week compared to a week earlier."
              ),
              tags$li("The total load has decreased by 43% since June 21, but there has been no significant trend, up or down, for the past three weeks."
              ),
              tags$li("BA.5 constituted 90% of the viral RNA entering Metro, and BA.4 and BA.2.75 represented 6% and 2%, respectively, of the total viral RNA load."
              )
            )
          )
        )
