      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: September 26, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            "This Week's Summary",
            h6("September 30, 2022"),
            p(
              "The most recent data update includes samples taken September 20 - September 26 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant decreased by 5% last week compared to a week earlier."
              ),
              ...
              tags$li("We continue to see BA.2.75 at levels around 1% in Metro influent."
              )
            )
          )
        )
