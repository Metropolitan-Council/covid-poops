      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: September 19, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            "This Week's Summary",
            h6("September 23, 2022"),
            p(
              "The most recent data update includes samples taken September 13 - September 19 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant decreased by 29% last week compared to a week earlier."
              ),
              tags$li("BA.5 constituted 90% of the viral RNA entering Metro, and BA.4 and BA.2 represented 7% and 1%, respectively, of the total viral RNA load."
              ),
              tags$li("We are intermittently seeing BA.2.75 at levels around 1% in Metro influent."
              )
            )
          )
        )
