      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: April 24, 2023. <br>*All data are preliminary and subject to revision</h3>"),
          ...
          tabPanel(
            ...
            h6("April 28, 2023"),
            p(
              "The most recent data update includes samples taken April 18 - April 24 2023. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant dropped by 6% last week compared to a week earlier."),
              tags$li("This level is 77% lower than it was nine weeks ago (mid-February) and lower than it has been at any time since late March 2022."),
              tags$li("XBB, a sublineage of BA.2, is the dominant variant, making up 92% of the viral RNA entering the plant last week.")
            )
          )
        )
      )
