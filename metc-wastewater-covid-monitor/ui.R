      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: January 9, 2023. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("January 13, 2023"),
            p(
              "The most recent data update includes samples taken January 3 2023 - January 9 2023. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant decreased by 12% last week compared to a week earlier."
              ),
              tags$li("The contribution of BA.2 sub-lineages to the viral RNA load entering Metro increased to 32% last week, while that of BA.5 sub-lineages decreased to 70%."
              ),
              tags$li("BA.2.75 and XBB subvariants are both subsets of the BA.2 lineage:",
                      tags$ul(tags$li("BA.2.75 made up approximately 4% of the viral RNA entering Metro last week, down from 5% a week earlier."
                      )),
                      tags$ul(tags$li("XBB made up 27% of the viral RNA entering Metro last week, nearly doubling the previous week’s level of 15%."
                      ))
              ),
              tags$li("BQ.1 subvariants are a subset of the BA.5 lineage. They made up approximately 56% of the viral RNA entering the Metro Plant last week, down from 62% a week earlier."
              )
            ),
            p(tags$b("Summary: "), "XBB sub-lineages are replacing BQ.1 sub-lineages in the Metro Plant service area, but the total level of virus decreased, week-over-week.")
          )
        )
      )
    ),
