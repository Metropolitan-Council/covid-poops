      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date:July 16, 2023. <br>*All data are preliminary and subject to revision</h3>"),
          ...
          tabPanel(
            ...
            h6("July 21, 2023"),
            p(
              "The most recent data update includes samples taken July 10 to July 16, 2023. During this sampling period:"
            ),
            tags$ul(
              tags$li("The weekly average viral RNA load entering the Metro Plant continues to vary week-to-week but remains at a low level."),
