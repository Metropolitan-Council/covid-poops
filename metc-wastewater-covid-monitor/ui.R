      ...
      fluidRow(
        ...
        tabsetPanel(
          ...
          tabPanel(
            ...
            HTML("<h6><section style='font-size:12pt;font-style:italic'>Last Sample Date: October 24, 2022. <br>*All data are preliminary and subject to revision</h3>"
            ),
          ...
          tabPanel(
            ...
            h6("October 28, 2022"),
            p(
              "The most recent data update includes samples taken October 18 - October 24 2022. During this sampling period:"
            ),
            tags$ul(
              tags$li("The total viral RNA load entering the Metro Plant increased by 21% last week compared to a week earlier."
              ),
              tags$li("Much of this increase is attributed to a high value observed on Monday, October 24."
              ),
              tags$li("Ignoring the high 10/24 sample, the viral load entering Metro still increased by 8% compared to the previous week."
              ),
              tags$li("BA.5 constituted 91% of the viral RNA entering Metro, and BA.4 and BA.2 represented 5% and 3%, respectively, of the total viral RNA load."
              )
            )
          )
        )
