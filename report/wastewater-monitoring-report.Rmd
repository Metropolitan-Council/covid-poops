...
This plot shows the total amount (“load”) of each variant entering the Metro Plant, over time.  BA.5 has been the dominant variant since early July 2022. XBB, a BA.2-derived recombinant lineage, has now replaced the BA.5-derived sub-lineages as the most prevalent SARS-CoV-2 variant in the Metro Plant service area.
