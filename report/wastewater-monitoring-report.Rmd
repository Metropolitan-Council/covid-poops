...
pal <- c("#84BB25", "#1D94B7", "#6D3571", "#D64776", "#FBC740", "#092D4E", "#A9A3FE", "#3D9F93", "#666666")
pal <- setNames(pal, c("Alpha, Beta & Gamma", "Delta", "Omicron BA.1", "Omicron BA.2 (Excluding BA.2.12.1)", "Omicron BA.2.12.1", "Omicron BA.4 and BA.5", "Omicron BA.4", "Omicron BA.5", "Total load"))
...
This plot shows the total amount (“load”) of each variant entering the Metro Plant, over time. Omicron BA.2.12.1 is currently the dominant variant in Metro Plant wastewater, but BA.4 and BA.5 are increasing and will likely soon overtake BA.2.12.1.
