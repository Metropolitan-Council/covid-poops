...
pal <- c("Total Viral Load" = "white",
         "Omicron BQ.1" = "#006400",
         "Omicron BA.5 (Excluding BQ.1)" = "#B19CD9",
         "Omicron BA.5" = "#000080",
         "Omicron BA.4" = "#3D9F93",
...
This plot shows the total amount (“load”) of each variant entering the Metro Plant, over time.  BA.5 has been the dominant variant since early July 2022. Currently, a BA.5 subvariant, BQ.1, is replacing other BA.5 sub-lineages, but the total prevalence of BA.5 remains above 90%.
