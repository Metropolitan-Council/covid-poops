...
This plot shows the total amount (“load”) of each variant entering the Metro Plant, over time.  BA.5 sublineages were the dominant variants between July 2022 and early January 2023. Recently, XBB replaced the BA.5-derived sublineages as the most prevalent SARS-CoV-2 variant in the Metro Plant service area.
